...
# ── 변환할 세력 설정 (이번 실행 대상) ────────────────────────────────────────
FACTION = {
    "src":        "4. 오벨리스크 대륙 (Obelisk Continent)/3. 잊힌 자들의 연합 (Forgotten Alliance)",
    "overview":   "잊힌 자들의 연합 (Forgotten Alliance).md",
    "out":        "잊힌자연합",
    "slug":       "forgotten-alliance",
    "kr":         "잊힌 자들의 연합",
    "continent":  "obelisk",
    "nav_region": "오벨리스크·망각",
    "rel_prefix": "01-8. 세력 아카이브/4. 오벨리스크 대륙/3. 잊힌 자들의 연합",
    "aliases":    ["잊힌 자들의 연합", "Forgotten Alliance", "포가튼 얼라이언스", "망각의 연합", "잊힌자 연합"],
}

# 이 세력의 그룹 카테고리 (가문/파벌/부족/씨족/세력/학파 — 세력마다 다름)
GROUP = "가문"
...
ENTITY = [
    ...
    ("1. 주요 장소 (Locations)/은신처",   "은신처",   "은신처",   "hideout"),
    ("1. 주요 장소 (Locations)/거래소",   "거래소",   "거래소",   "market"),
    ("3. 가문 (Noble Houses)",            GROUP,      GROUP,      "house-group"),
]
HOUSE_INDEX_SRC = "3. 가문 (Noble Houses)/0. 잊힌 자들의 연합 가문 관계도.md"
