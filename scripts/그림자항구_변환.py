...
# ── 변환할 세력 설정 (이번 실행 대상) ────────────────────────────────────────
FACTION = {
    "src":        "3. 프로스트 대륙 (Frost Continent)/4. 그림자 항구 (Shadowwake Cove)",
    "overview":   "그림자 항구 (Shadowwake Cove).md",
    "out":        "그림자항구",
    "slug":       "shadowwake-cove",
    "kr":         "그림자 항구",
    "continent":  "frost",
    "nav_region": "프로스트·항만",
    "rel_prefix": "01-8. 세력 아카이브/3. 프로스트 대륙/4. 그림자 항구",
    "aliases":    ["그림자 항구", "Shadowwake Cove", "섀도우웨이크 코브", "암영 항만", "해적 자유항"],
}
...
HOUSE_INDEX_SRC = "3. 파벌 (Factions)/0. 그림자 항구 세력 관계도.md"
