...
# ── 변환할 세력 설정 (이번 실행 대상) ────────────────────────────────────────
FACTION = {
    "src":        "4. 오벨리스크 대륙 (Obelisk Continent)/4. 봉인 수호단 (Seal Wardens)",
    "overview":   "봉인 수호단 (Seal Wardens).md",
    "out":        "봉인수호단",
    "slug":       "seal-wardens",
    "kr":         "봉인 수호단",
    "continent":  "obelisk",
    "nav_region": "오벨리스크·봉인",
    "rel_prefix": "01-8. 세력 아카이브/4. 오벨리스크 대륙/4. 봉인 수호단",
    "aliases":    ["봉인 수호단", "Seal Wardens", "씰 워든", "봉인의 수호단", "봉인기사단"],
}
...
HOUSE_INDEX_SRC = "3. 파벌 (Factions)/0. 봉인의 수호단 파벌 관계도.md"
