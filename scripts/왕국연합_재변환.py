...
# ── 변환할 세력 설정 (이번 실행 대상) ────────────────────────────────────────
FACTION = {
    "src":        "1. 에테르 대륙 (Ether Continent)/2. 왕국연합 (Allied Kingdoms)",
    "overview":   "왕국연합 (Allied Kingdoms).md",
    "out":        "왕국연합",
    "slug":       "allied-kingdoms",
    "kr":         "왕국연합",
    "continent":  "ether",
    "nav_region": "에테르·왕국",
    "rel_prefix": "01-8. 세력 아카이브/1. 에테르 대륙/2. 왕국연합",
    "aliases":    ["왕국연합", "Allied Kingdoms", "얼라이드 킹덤", "3왕국 동맹", "카멜로스 연합"],
}
...
HOUSE_INDEX_SRC = "3. 가문 (Noble Houses)/0. 왕국연합 가문 관계도.md"
