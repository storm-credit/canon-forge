...
봉인수호단_변환.py와 동일 패턴. 해양 대륙 2번 세력 — 황금 함대.
...
FACTION = {
    ...
    "overview":   "황금 함대 (Golden Armada).md",
    "out":        "황금함대",
    "slug":       "golden-armada",
    "kr":         "황금 함대",
    "continent":  "oceanic",
    "nav_region": "해양",
    "rel_prefix": "01-8. 세력 아카이브/5. 해양 대륙/2. 황금 함대",
    "aliases":    ["황금 함대", "Golden Armada", "골든 아르마다", "황금함대"],
}
...
ENTITY = [
    ...
    ("3. 가문 (Noble Houses)",            GROUP,      GROUP,      "faction-group"),
]
HOUSE_INDEX_SRC = "3. 가문 (Noble Houses)/0. 황금 함대 가문 관계도.md"
