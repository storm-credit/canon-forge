...
# ── 변환할 세력 설정 (이번 실행 대상) ────────────────────────────────────────
FACTION = {
    "src":        "1. 에테르 대륙 (Ether Continent)/1. 성국 (Saint Haven)",
    "overview":   "성국 (Saint Haven).md",
    "out":        "성국",
    "slug":       "saint-haven",
    "kr":         "성국",
    "continent":  "ether",
    "nav_region": "에테르·신정",
    "rel_prefix": "01-8. 세력 아카이브/1. 에테르 대륙/1. 성국",
    "aliases":    ["성국", "Saint Haven", "세인트 헤이븐", "빛의 신정 왕국", "솔라리스 신정국"],
}
...
HOUSE_INDEX_SRC = "3. 가문 (Noble Houses)/0. 성국 가문 관계도.md"
