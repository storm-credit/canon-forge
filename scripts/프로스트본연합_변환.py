...
FACTION = {
    "src":        "3. 프로스트 대륙 (Frost Continent)/2. 프로스트본 연합 (Frostborn Tribes)",
    "overview":   "프로스트본 연합 (Frostborn Tribes).md",
    "out":        "프로스트본연합",
    "slug":       "frostborn-tribes",
    "kr":         "프로스트본 연합",
    "continent":  "frost",
    "nav_region": "프로스트·설원",
    "rel_prefix": "01-8. 세력 아카이브/3. 프로스트 대륙/2. 프로스트본 연합",
    "aliases":    ["프로스트본 연합", "Frostborn Tribes", "프로스트본", "설원 부족 연합", "서리한 부족"],
}
...
TRIBE_INDEX   = "3. 부족 (Tribes)/0. 프로스트본 연합 관계도.md"
