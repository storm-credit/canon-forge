...
봉인수호단_변환.py와 동일 패턴. 해양 대륙 1번 세력 — 해적 연합.
...
FACTION = {
    ...
    "overview":   "해적 연합 (Pirate Confederacy).md",
    "out":        "해적연합",
    "slug":       "pirate-confederacy",
    "kr":         "해적 연합",
    "continent":  "oceanic",
    "nav_region": "해양",
    "rel_prefix": "01-8. 세력 아카이브/5. 해양 대륙/1. 해적 연합",
    "aliases":    ["해적 연합", "Pirate Confederacy", "해적왕국", "피라트 컨페더러시"],
}
...
HOUSE_INDEX_SRC = "3. 파벌 (Factions)/0. 해적 연합 세력 관계도.md"
