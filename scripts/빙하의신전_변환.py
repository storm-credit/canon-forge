...
# ── 변환할 세력 설정 (이번 실행 대상) ────────────────────────────────────────
FACTION = {
    "src":        "3. 프로스트 대륙 (Frost Continent)/3. 빙하의 신전 (Frozen Sanctum)",
    "overview":   "빙하의 신전 (Frozen Sanctum).md",
    "out":        "빙하의신전",
    "slug":       "frozen-sanctum",
    "kr":         "빙하의 신전",
    "continent":  "frost",
    "nav_region": "프로스트·빙궁",
    "rel_prefix": "01-8. 세력 아카이브/3. 프로스트 대륙/3. 빙하의 신전",
    "aliases":    ["빙하의 신전", "Frozen Sanctum", "프로즌 생텀", "빙하 신정국", "영원의 빙궁"],
}
...
HOUSE_INDEX_SRC = "3. 파벌 (Factions)/0. 빙하의 신전 가문 관계도.md"
