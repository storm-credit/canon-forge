---
정본명: 타르타로스 노예 옥션 (Tartarus Slave Auctions)
유형: 영웅 백과 인덱스
출처: "01-14. 영웅 백과 (Hero Archive)/01-14-2. 현존 영웅/6. 범대륙 초국가 및 중립 영웅/6-2. 대륙 무역 상단 소속 (Syndicates)/7. 타르타로스 노예 옥션 (Tartarus Slave Auctions)"
검증상태: Phase 3 전수 보존 (원문 보존, 2026-06-23)
---

# ⚔️ 타르타로스 노예 옥션 (Tartarus Slave Auctions)

## 항목

| # | 영웅 |
|---|------|
| 1 | [가웨인 라크루아 (Gawain Lacroix)](01.가웨인라크루아.md) |
| 2 | [미하일 크림슨 (Mikhail Crimson)](02.미하일크림슨.md) |
| 3 | [보리스 그레이 (Boris Gray)](03.보리스그레이.md) |
