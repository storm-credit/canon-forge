---
정본명: 그리핀 기사단 (Order of the Gryphon)
유형: 영웅 백과 인덱스
출처: "01-14. 영웅 백과 (Hero Archive)/01-14-2. 현존 영웅/6. 범대륙 초국가 및 중립 영웅/6-3. 대륙 용병단 소속 (Mercenaries)/2. 그리핀 기사단 (Order of the Gryphon)"
검증상태: Phase 3 전수 보존 (원문 보존, 2026-06-23)
---

# ⚔️ 그리핀 기사단 (Order of the Gryphon)
