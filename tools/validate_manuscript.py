...
BAN = ['우주적 십자가', '잔혹한 대가', '혹독한 대가', 'Epic Penalty', '코스믹 호러',
       ...
       '채귀', '위작', '순정보', '응당',  # 어휘 스윕 승격 (작가 확정 2026-07-28) — 채귀→빚쟁이 / 위작→가짜 / 순정보→평서 / 응당→당연히
       # ※ '시진'(무협 시간 단위)은 권고 보류 — 구판 015·089화 산문에 선행 사용 2건(시간 환산=수치 변경 필요, 작가 판단 대기)
       '천잠', '골드로저',  # 차용 고유명 개명 잔재 방어 (모티브 감사 2026-07-15)
