...
FALSE=re.compile(r'(좀비급|헤비급|S비급|구강호|순도인|인도인|주도인|과도인|정도인|지도인|유도인|설계도인|하수도인|보도인|단전투|차단전|단전시|단전이 아|기공사|기공학|기공식|공기공|분기공|대기공|기공포|고기공|장풍\(長風\)|성좌 혈도|성좌혈도|유혈도|빛무림|초식 맹수|초식수|초식 마수|초식 동물|대형 초식|고무공|무기공장|성불하지 못한|성불 따위|성불은|한백무림서)')
OK=('크로니클-로드맵','앵커시드','영웅생성표준','잊히지 않는 단심','세계의-헌법','감시자','_작업','_인수인계','_동명판정','_collisions','_전수분석','_progress','_종족혈통','_정본명','_커버리지','_PLAN','_구조설계','_phase3','_백과수렴')
n=0
